...
**Inherits:** [IAlgebraBasePluginV1](interfaces/IAlgebraBasePluginV1.md) [IAlgebraPlugin](../Core/interfaces/plugin/IAlgebraPlugin.md) [Initializable](https://docs.openzeppelin.com/contracts/4.x/) TimestampUpgradeable
## Modifiers
### onlyPool
