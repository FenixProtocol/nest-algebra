...
**Inherits:** [IAlgebraFactory](interfaces/IAlgebraFactory.md) [Ownable2StepUpgradeable](https://docs.openzeppelin.com/contracts/4.x/) [AccessControlEnumerableUpgradeable](https://docs.openzeppelin.com/contracts/4.x/)
...
### POOL_INIT_CODE_HASH
```solidity
bytes32 constant POOL_INIT_CODE_HASH = 0xe4894f29e2491e531db85584561de8b8869774d41313c860cf4089d80a51d8a4
```
**Selector**: `0xdc6fd8ab`
