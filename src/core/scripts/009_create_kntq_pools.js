...
async function main() {
  ...
  // console.log(encodePriceSqrt(169_000n, 1_000_000_000_000_000_000n));
  const pairs = [
    // ['KNTQ-USDH', KNTQ, USDH, encodePriceSqrt(169_000n, 1_000_000_000_000_000_000n), 50n, 0.25e4],
    ['KNTQ-WHYPE',  KNTQ, WHYPE, encodePriceSqrt(4157100000000000n, 1000000000000000000n), 50n, 0.25e4],
    ['KNTQ-kHYPE',  KNTQ, kHYPE, encodePriceSqrt(4157100000000000n, 1000000000000000000n), 50n, 0.25e4],
  ];
